...
public class TelaJogo extends TelaBase {
    ...
    /**
     *  recria a tela dpp jogo todos os seus componentes
     */
    private void reiniciarJogo() {
        //aqui vai o codigo de reinicio
    ...
    private void atualizarObstaculos() {
        ...
        //verifica se o obstaculo sairam da tela para remove-los

        for(Obstaculo o : obstaculos){
            //calcular a lateral inicial da camera
    ...
    /**
     * atualizar a posicao do chao para acompanhar o passaro
     */
